package com.elad.youtube.utills
{
	...
	public class GetVideosList extends EventDispatcher
	{
		...
		private var maxFeedLength:Number = 3;
		...
		private function feedsEventHandler(event:*):void
		{
			...
			while (videoData = feed.next()) 
			{
				...
				var youTubeVideo:YouTubeVideoVO = new YouTubeVideoVO(videoData.title, videoData.content ,thumbArray[0], videoData.actualId, videoData.viewCount.toString());
