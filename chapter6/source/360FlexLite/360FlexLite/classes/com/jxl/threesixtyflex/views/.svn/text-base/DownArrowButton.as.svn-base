...
class com.jxl.threesixtyflex.views.DownArrowButton extends Button
{
	public static var SYMBOL_NAME:String = "com.jxl.threesixtyflex.views.DownArrowButton";
