 ...
 */
class com.blocketpc.utils.GDispatcher {
	 ...
	 * 
	 * @param p_obj: Class to add the dispatcher.
	 */
	...
	private static function $indexOfListener(p_listeners:Array,p_obj:Object,p_function:String):Number {
	...
	private static function $dispatchEvent(p_dispatchObj:Object,p_listeners:Array,p_eventObj:Object) {
		var i:String;
