...
class com.blocketpc.components.NavigationMenuLight extends AbstractObject
{
	...
	{
		KeyManager.getInstance().addEventListener(KeyManager.ON_PRESS_KEY, EventDelegate.create(this, onPressKey));
	...
	public function set activated(a:Boolean):Void
	{
		...
		if (_activated) KeyManager.getInstance().addEventListener(KeyManager.ON_PRESS_KEY, EventDelegate.create(this, onPressKey));
		else KeyManager.getInstance().removeAllEventListeners();
	}
