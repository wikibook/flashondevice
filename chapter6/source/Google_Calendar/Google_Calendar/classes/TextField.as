...
dynamic intrinsic class TextField
{
	...
	// Comment out the below if you don't want the TextField
	// decorated properties & methods
	// -----------------------------------------------------------------------
	public static var ALIGN_LEFT:String;
	public static var ALIGN_CENTER:String;
	public static var ALIGN_RIGHT:String;
	
	public static var TYPE_DYNAMIC:String;
	public static var TYPE_INPUT:String;
