...
class com.blocketpc.components.SoftKeysLight extends AbstractObject
{
	 ...
	 * 
	 * @param screenPos: Number value with position
	 * 0 - TOP
	 * 1 - LEFT
	 * 2 - BOTTOM
	 * 3 - RIGHT
	 * 4 - RIGHT WITH SOFTKEYS ROTATED
	 * 
	 * Feel free to add more if you need it :)
	 */
	public function setPosition(screenPos:Number):Void
	{
		softLeft._rotation = 0;
		softRight._rotation = 0;
		...
		switch (screenPos)
		{
			...
			case 4:
				//RIGHT WITH ROTATION
				softLeft._rotation = 90;
				softRight._rotation = 90;
				
				softLeft._x = softLeft._width;
				softLeft._y = Stage.height - softLeft._height;
				
				softRight._x = Stage.width;
				softRight._y = Stage.height - softRight._height;
			break;
		}
	}
